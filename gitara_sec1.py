...
for hx in (-21, -9, 5, 21):
    p0 -= Pos(hx, 249, 0.75) * Cylinder(1.6, 1.7)     # сквозь полку (бутерброд)      # в дне Ø2.6 — М3 сам нарежет
...
spicas = []
for k in range(4):
    ln = 250 - AXES_Y[k]                   # от угла-1 до юга секции (+хвост)
