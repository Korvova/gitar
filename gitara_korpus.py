...
top_p -= BB(-28.1, 28.1, 479.9, 506.5, 22.9, 26.1)     # окно насквозь
for x0, x1 in ((-28, 1), (19, 28)):
    top_p += BB(x0, x1, 480, 510, 20, 23)              # бобышки (мимо лент)
for sx in (-24, 24):
    top_p -= Pos(sx, 490, 21.4) * Cylinder(1.3, 3.4)   # каналы Ø2.6
