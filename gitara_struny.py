...
tp2 += BB(-12.5, 12.5, -12.5, 12.5, 3, 4.5)            # рамка платы AS5600
tp2 -= BB(-11.4, 11.4, -11.4, 11.4, 2.9, 4.6)          # …внутренний карман 22.8
tp2 -= BB(-20.1, -9, -3, 3, -0.1, 4.6)                 # прорезь проводов на запад
