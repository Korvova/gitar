...
# лок: z0 = НИЗ струны
sk = BB(-3, 3, -4, 4, -2.6, 0)                         # дно с ямкой магнита
...
for px in (-1, 1):                             # СКВОЗНЫЕ прорези под штырьки:
    tp2 -= BB(px * 3.5, px * 11.4, -9, 9,      # ШИРОКИЕ до центра (юзер) — где
              -0.1, 6.2)                       # бы ни были пины, места хватит
