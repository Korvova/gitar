...
for i, sx in enumerate(SX):
    ...
    PCB.append((mx, my))
    rama += BB(mx - 12.9, mx + 12.9, my - 12.9, my + 12.9, 3, 8.5)
    rama -= BB(mx - 11.7, mx + 11.7, my - 11.7, my + 11.7, 6.1, 8.6)  # карман
    rama -= BB(mx - 11.4, mx - 3.5, my - 9, my + 9, -0.1, 6.2)   # пины запад
    rama -= BB(mx + 3.5, mx + 11.4, my - 9, my + 9, -0.1, 6.2)   # пины восток
    # крепление платы БЕЗ металла (юзер): козырёк с севера + зубчик с юга —
    # плата заводится под козырёк и вщёлкивается (как батарейная крышка)
    rama += BB(mx - 4, mx + 4, my - 11.7, my - 10.9, 7.75, 8.5)  # козырёк
    rama += BB(mx - 2, mx + 2, my + 11.35, my + 11.7, 7.78, 8.1) # зубчик
