...
sk = BB(-2.3, 2.3, -4, 4, -2, -1)                      # дно СПЛОШНОЕ (юзер;
                                                       # пластик полю не мешает)
...
tp2 += BB(-12.8, 12.8, -12.8, 12.8, 3, 10)             # подиум платы AS5600
tp2 -= BB(-11.4, 11.4, -11.4, 11.4, 8.4, 10.1)         # карман: чип на ~10.9,
tp2 -= BB(-20.1, -9, -3, 3, 8.3, 10.1)                 # зазор до магнита ~2.7
