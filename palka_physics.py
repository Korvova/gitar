...
POS = {
    ...
    "ptest_bridge_high_v1": ((30, 6, 14.9), 90),
}
...
set_rb(OBJ["ptest_bridge_high_v1"], 'PASSIVE', 'MESH')  # высокий мост над тележкой
...
c_box(sp, 9.5, 119, -2.5, 2.5, 0, 1.6)
c_ring(sp, 4, 0, 0, 1.6, 3.0, 5.5)
c_box(sp, 115, 132.75, -2.5, 2.5, 1.4, 3.0)
